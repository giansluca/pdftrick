...
public class ModalWarningPanel {
    ...
    private static final UserInterface userInterface = BAG.getUserInterface();
    ...
    public static void displayArchWarningAndThrow() {
        ...
        SwingInvoker.invokeAndWait(() -> displayGenericWarningPanel(null, message, WARNING));
    ...
    public static void displayLoadingPdfThumbnailsWarning() {
        ...
        SwingInvoker.invokeLater(() -> displayGenericWarningPanel(userInterface, message, WAIT));
    }
    ...
    private static void displayGenericWarningPanel(Component parentComponent, String message, String title) {
