...
public class RightPanel {
	...
	private final ImageIcon getImages_icon = new ImageIcon(FileLoader.loadFileAsUrl(Constants.GET_IMG_ICO));
	private final ImageIcon cancel_icon = new ImageIcon(FileLoader.loadFileAsUrl(Constants.CANCEL_ICO));
	private final ImageIcon cleanSelection_icon = new ImageIcon(FileLoader.loadFileAsUrl(Constants.CLEAN_SEL_ICO));
